...
{
    const VERSION = '1.0.0';
    const POST_RECRUITER_API = 'api/recruiter';
    ...
    protected $recruiterApiBabeUri;
    public function __construct($secret_key, $recruiterApiBabeUri, $isAsyncRequest = false, $httpClient = null)
    {
        $this->secret_key = $secret_key;
        $this->recruiterApiBabeUri = $recruiterApiBabeUri;
        $this->isAsyncRequest = $isAsyncRequest;
        $this->client = $httpClient ?: new Client([
            'base_uri' => $this->recruiterApiBabeUri,
    ...
    public function saveRecruiter($query = [], $formParameters = [], $file = null) {

        $this->setHeaders(['Content-type' => 'application/json']);
        $uri = self::POST_RECRUITER_API;
